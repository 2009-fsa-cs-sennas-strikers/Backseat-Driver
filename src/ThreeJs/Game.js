  ...
  <>
   ...
   <Canvas>
        ...
        <Physics gravity={[0, -100, 0]}>
          ...
          {<Car action={this.state.action} setAction={this.voiceAction} carPosition={[0,5,100]} stopListening={stopListening} changeWin={this.props.changeWin} changePlaying={this.props.changePlaying} store={store}/>}
          </Suspense>
          <EndZone store={store}/>
          {/* One Row */}
